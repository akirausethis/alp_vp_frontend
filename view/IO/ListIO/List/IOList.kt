package com.example.alp_vp.view.IO.ListIO.List
...
import com.example.alp_vp.view.IO.ListIO.Card.IOListCard

@Composable
fun CRListScreen(modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
            .fillMaxSize()
        ...
        Column(
            ...
            Text(
                text = "All On-going International Office Events",
                style = TextStyle(
                    color = Color.Gray,
                    fontSize = 14.sp
                )
