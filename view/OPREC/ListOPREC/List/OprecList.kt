package com.example.alp_vp.view.OPREC.ListOPREC.List
...
import com.example.alp_vp.view.OPREC.ListOPREC.Card.OprecListCard

@Composable
fun OprecListScreen(modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
            .fillMaxSize()
        ...
        Column(
            ...
            Text(
                text = "All On-going Open Recruitment Events",
                style = TextStyle(
                    color = Color.Gray,
                    fontSize = 14.sp
                )
