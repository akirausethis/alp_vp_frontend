...
export class PanitiaController {
  ...
  static async getAllPanitia(
    ...
    try {
      const response = await PanitiaService.getAllPanitia(req.user!);
  ...
  static async getPanitia(req: UserRequest, res: Response, next: NextFunction) {
    try {
      const response = await PanitiaService.getPanitia(req.user!, 
        Number(req.params.panitiaId));
  ...
  static async createPanitia(
    ...
    try {
      ...
      const response = await PanitiaService.createPanitia(req.user!, request);
  ...
  static async updatePanitia(
    ...
    try {
      ...
      const response = await PanitiaService.updatePanitia(req.user!, request);
  ...
  // Menghapus panitia
  static async deletePanitia(req: UserRequest, res: Response, next: NextFunction) {
    try {
      const response = await PanitiaService.deletePanitia(req.user!, Number(req.params.panitiaId));
